...
/processed
    user_clusters_kmeans_final.csv   # Clusters de usuários (KMeans)
    cluster_top_species.csv          # Top espécies por cluster
    cluster_centroids_gradient_map.html  # Mapa interativo centroids + gradiente
    cluster_ecoprofile_map.html      # Mapa temático com perfis ecológicos
    cluster_ecoprofile_summary.csv   # Resumo clusters por perfil ecológico
/scripts
    generate_maps_and_profiles.py    # Script principal para análise e mapas
/figs
    cleaned_analysis/
    hdbscan/
    sao_paulo_filter_map.png         # Exemplo de figura estática
```
...
Autores: # Projeto: Análise de Clusters de Usuários e Perfil Ecológico em São Paulo
...
Autores: Aleksej Kozlakowski Junior, Gabriele da Silva Campos, Gabriele da Silva Campos, Tiago Belintani, Victor ???,  
Data: 2025
